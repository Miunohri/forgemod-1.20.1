package net.miunohri.enhancementmod.custom;
...
import net.miunohri.enhancementmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP = (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
            .put(ModArmorMaterials.CLOTH, new MobEffectInstance(MobEffects.MOVEMENT_SPEED,200, 1, false, false, true)).build();
    ...
    private boolean hasFullSuitOfArmorOn(Player player) {
        ...
        return !helmet.isEmpty() && leggings.isEmpty() && breastplate.isEmpty() && boots.isEmpty();
    }
